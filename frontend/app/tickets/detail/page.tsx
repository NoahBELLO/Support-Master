...
export default function Page() {
  return (
    <Suspense fallback={<div className="flex flex-1 items-center justify-center"><p className="text-sm text-zinc-400">Chargement…</p></div>}>
      <TicketDetailPage />
    </Suspense>
  )
}
...
function TicketDetailPage() {
  ...
  useEffect(() => {
    ...
    if (!id) { router.push('/tickets'); return }
